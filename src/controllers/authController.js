...
let postRegister = async (req, res)=>{
    ...
    if( !validationErrors.isEmpty() ){
        ...
        return res.redirect("/login-register"); // chuyển biến error sang login-register
        ...
        try {
            ...
            return res.redirect("/login-register"); // chuyển biến success sang login-register
